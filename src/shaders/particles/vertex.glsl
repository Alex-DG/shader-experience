...
void main() {
    // vec3 newPosition = sin(vec3(position.x, position.y, position.z) + uTime * 0.2);
    ...
    // float elevation = sin(modelPosition.x - uTime) * 0.1;
    // elevation += sin(modelPosition.y - uTime) * 0.1;
